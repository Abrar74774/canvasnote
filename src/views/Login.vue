							...
							<form class="mt-8">
								<div class="mx-auto max-w-lg">
									...
									<div class="py-2">
										...
										<div class="relative">
											<input placeholder="" class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
