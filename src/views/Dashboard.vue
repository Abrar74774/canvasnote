                    ...
                    <li> <!-- Canvases -->
                        <div v-for="(canvas, i) of state.canvasList" @click="loadCanvas(canvas.name, i)"
                            ...
                            <div class="flex-2 flex ml-auto">
                                <button @click.stop="startEdit(i)" class=" bg-gray-600 hover:bg-gray-500 font-medium rounded-full text-sm p-2 ml-1 w-10 h-10">
                                    ✏️
                                </button>
                                <button @click.stop="deleteCanvas(canvas.name)" class="bg-gray-600 hover:bg-gray-500 font-medium rounded-full text-sm p-2 ml-1 w-10 h-10">
